CREATE OR REPLACE FUNCTION public.fast_fetch_studies_paginated_filter_v6(p_column_filters jsonb DEFAULT '[]'::jsonb, p_sorting jsonb DEFAULT '[]'::jsonb, p_index integer DEFAULT 0, p_size integer DEFAULT 10)
 RETURNS jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
